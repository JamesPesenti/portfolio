...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 50, marginBottom: -50}}>I created a mobile app clone of the popular Airbnb platform using React Native. Currently, the project includes a functional UI that mimics the 2022 Airbnb interface, with features such as</p>
            <p style={{fontSize: 20, paddingHorizontal: 0}}> &#8226; Google Maps functionality to select an Airbnb on the map based on price.</p>
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 40}}>I plan to add additional features and integrate back end functionality in future updates to enhance the user experience and provide a more comprehensive product.</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 30, marginBottom: -20}}><b> Key Skills I learned: </b>React Native, UI design, mobile development, UX design, project management.</p>
