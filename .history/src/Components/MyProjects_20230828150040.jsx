  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
           ...
           <div numberOfLines={1} style={{display: 'flex', flexDirection: "row", width: "60%"}}>
            <p style={{fontSize: 16, padding: 0, marginBottom: 0}}>&#8226; Google autocomplete search</p>
            <p style={{fontSize: 16, padding: 0, marginBottom: 0}}>&#8226; Image carousel with pagination</p>
            <p style={{fontSize: 16, paddingHorizontal: 0, marginBottom: 0}}> &#8226; OpenAI API integration prompting ChatGPT to act as a chatbot for guest property recommendations.</p>
            <p style={{fontSize: 16, paddingHorizontal: -90, marginBottom: 0}}> &#8226; Google Maps functionality to select an Airbnb on the map based on price.</p>
