...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{marginTop: 30, marginBottom: 20, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -80}}><b> Key Skills I learned: </b>React Native, UI design, mobile development, UX design, project management.</p>
