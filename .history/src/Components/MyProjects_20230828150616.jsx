  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
           ...
           <div style={{display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)'}}>
            ...
            <p style={{fontSize: 16}}>&#8226; Image carousel with pagination OpenAI API integration prompting</p>
            <p style={{fontSize: 16}}> ChatGPT to act as a chatbot for guest property recommendations.</p>
