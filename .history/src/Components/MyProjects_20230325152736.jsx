...
const MyProjects = () => {
  ...
  <>
    ...
    {/* Uber Eats App */}
    <div style={{marginTop: 300, marginBottom: 60, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
        ...
        {/* Donut Shop App */}
    <div style={{marginTop: 30, marginBottom: 20, justifyContent: 'center', alignItems: 'center',  width: "90%", borderRadius: 10}} className="box">
            <div className="imgWrapper" style={{width: 480, height: 350}}>
                <img style={{ borderRadius: 5, marginTop: 50, width: "100%", height: 300, transition: ".7s", }} src="/images/Screenshot 2023-03-25 152620.png" />
            </div>
