...
const MyProjects = () => {
  ...
  <>
    ...
    {/* Airbnb Clone */}
    <div style={{marginTop: 30, marginBottom: 0, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            <div>
