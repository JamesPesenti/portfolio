...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{marginTop: 30, marginBottom: 20, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -50}}><b> Key Skills I learned: </b>React Native, UI design, mobile development, UX design, project management.</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 40}}><b> Impact: </b> Each project has allowed me to gain experience in mobile development and hone my skills in UI and UX design. It has also provided me with the opportunity to practice project management, by being responsible for planning and executing the project from start to finish.</p>
