...
const MyProjects = () => {
  ...
  <>
    ...
    {/* Uber Eats App */}
    <div style={{flexDirection: "row", marginTop: 300, marginBottom: 120, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            <div className="imgWrapper" style={{width: 480, height: 350, flexDirection: "row"}}>
            <img style={{ marginTop: 50, width: "100%", height: 300, transition: ".7s", }} src="/images/UberEats4.png" />
                <img style={{ marginTop: 50, width: "100%", height: 300, transition: ".7s", }} src="/images/UberEats4.png" />
            </div>
