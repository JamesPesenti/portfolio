  ...
  {/* Aston Waikiki */}
    <div id="parallaxContainer">
       ...
       <div style={{marginTop: 300, marginBottom: 120, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <div style={{alignItems: 'center', justifyContent: "center", marginRight: 150}}>
                <a href="https://github.com/JamesPesenti" target="_blank" rel="noopener noreferrer">
                    <FaGithub size={55} style={{ justifyContent: "center", textAlign: "center", marginLeft: 180}} />
                </a>
            </div>
            <GoogleButton style={{position: "center", marginLeft: -20 }} />
