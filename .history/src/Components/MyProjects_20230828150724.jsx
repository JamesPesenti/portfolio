...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
           ...
           <div>
            <p style={{fontSize: 20, textAlign: 'center', padding: 20, marginTop: 40}}>I created a mobile app clone of the popular Airbnb platform using React Native. Currently, the project includes a functional UI that mimics the 2022 Airbnb interface, with features such as</p>
           </div>
           <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 4fr)'}}>
            <p style={{fontSize: 16}}>&#8226; Google autocomplete search</p>
            <p style={{fontSize: 16}}>&#8226; Image carousel with pagination OpenAI API integration prompting ChatGPT to act as a chatbot for guest property recommendations.</p>
