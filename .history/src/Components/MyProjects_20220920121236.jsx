  ...
  {/* Aston Waikiki */}
    <div id="parallaxContainer">
       ...
       <div style={{marginTop: 300, marginBottom: 120, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <GoogleButton type="button" className="button" style={{position: "center", marginLeft: -220}} />
            ...
            <GoogleButton type="button" className="button" style={{position: "center", marginLeft: 80,}} />
        </div>
