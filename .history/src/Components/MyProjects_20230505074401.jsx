...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{marginTop: 30, marginBottom: 20, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20,textAlign: 'center', padding: 50}}>I created a mobile app clone of the popular Airbnb platform using React Native. Currently, the project includes a functional UI that closely mimics the Airbnb interface, with features such as search and filter options, listing detail pages, and a user profile screen. I plan to add additional features and integrate backend functionality in future updates.
