...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, paddingHorizontal: 0, marginBottom: -20}}> &#8226; OpenAi API integration prompting ChatGPT-3 to act as a chatbot for guest property recommendations.</p>
            ...
            <p style={{fontSize: 20, padding: 0, marginBottom: -20}}>&#8226; Property detail screens</p>
