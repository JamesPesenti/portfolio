  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
           ...
           <div style={{padding: 50}}>
                <p style={{fontSize: 20, textAlign: 'center', marginBottom: -60}}>I created a mobile app clone of the popular Airbnb platform using React Native. Currently, the project includes a functional UI that mimics the 2022 Airbnb interface, with features such as</p>
                ...
                <p style={{fontSize: 20, textAlign: 'center', marginBottom: -60}}>I plan to add additional features and integrate back end functionality in future updates to enhance the user experience and provide a more comprehensive product.</p>
                <p style={{fontSize: 20, textAlign: 'center', marginBottom: -80}}><b> Key Skills I learned: </b>React Native, UI design, Google Play and App Store submission process, mobile development, UX design, project management.</p>
                <p style={{fontSize: 20, textAlign: 'center'}}><b> Impact: </b> Each project has allowed me to gain experience in mobile development and hone my skills in UI and UX design. It has also provided me with the opportunity to practice project management, by being responsible for planning and executing the project from start to finish, providing me with valuable experience of the mobile app lifecycle.</p>
           </div>
