...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -70}}>&#8226; property detail screens</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -70}}></p>&#8226; an image carousel with pagination</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -70}}> &#8226; and Google Maps functionality to select Airbnb's on the map based on price. I plan to add additional features and integrate backend functionality in future updates to enhance the user experience and provide a more comprehensive product.</p>
