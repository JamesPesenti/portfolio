...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{marginTop: 30, marginBottom: 20, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            <div className="imgWrapper" style={{width: 400, height: 320}}>
                <img style={{ borderRadius: 5, marginTop: 50, width: "110%", height: 250, transition: ".7s", }} src="/images/Screenshot 2023-03-25 152620.png" />
            </div>
