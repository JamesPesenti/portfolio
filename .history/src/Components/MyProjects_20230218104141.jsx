...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{marginTop: 300, marginBottom: 120, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20,textAlign: 'center', padding: 50}}>A full stack react native app inspired by the UberEats user app. I utilized Aws Amplify's datastore to to configure the back end to query and save customer's orders and used Amazon Cognito for user registration, authentication, & account recovery.</p>
