...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 0, marginBottom: -10}}>&#8226; Google autocomplete search</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 0, marginBottom: -10}}>&#8226; Property detail screens</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 0, marginBottom: -10}}>&#8226; Image carousel with pagination</p>
