...
import Pdf from "../Components/James Pesenti Resume 2023.pdf"
            ...
            <div className="container">
                <nav>
                  <ul style={{textAlign: "center", marginTop: 70, position: 'relative', left: 0, top: -2}}>
                    <li>
                      <a className="App-link"  href="mailto:JamesPesenti.Code@gmail.com" target="_blank" rel="noopener noreferrer">
