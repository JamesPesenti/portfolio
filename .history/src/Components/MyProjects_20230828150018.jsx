...
const MyProjects = () => {
  ...
  <>
    <div id="parallaxContainer" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }}>

    {/* Airbnb Clone */}
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            <div>
                <img style={{ borderRadius: 10, marginTop: 30, marginBottom: -35, width: "100%", height: 450, transition: ".7s", }} src="images/mockrocket-capture (11).png" />
            </div>
            <h4 style={{textAlign: 'center'}}>Airbnb Clone App</h4>
                <div style={{padding: 10, borderRadius: 10, marginBottom: -40,}}>
           ...
           <div numberOfLines={1} style={{display: 'flex', flexDirection: "row", width: "60%"}}>
            <p style={{fontSize: 16, padding: 0, marginBottom: -20}}>&#8226; Google autocomplete search</p>
            <p style={{fontSize: 16, padding: 0, marginBottom: -20}}>&#8226; Image carousel with pagination</p>
            <p style={{fontSize: 16, paddingHorizontal: 0, marginBottom: -20}}> &#8226; OpenAI API integration prompting ChatGPT to act as a chatbot for guest property recommendations.</p>
            <p style={{fontSize: 16, paddingHorizontal: -90, marginBottom: -20}}> &#8226; Google Maps functionality to select an Airbnb on the map based on price.</p>
    ...
    {/* Barcelona App */}
       <div style={{marginTop: 20, marginBottom: 120, justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <h4 style={{textAlign: 'center'}}>Barcelona Tourist App</h4>
                <div style={{padding: 10, borderRadius: 10, marginBottom: -20,}}>
                <img style={{width: 80, height: 50,}} src="https://www.datocms-assets.com/45470/1631026680-logo-react-native.png"  />
                <img style={{width: 50, height: 50, borderRadius: 50}} src="https://i.pinimg.com/originals/8a/02/1a/8a021aa097236b42dd71fb731e3d894d.gif"/>
                </div>
