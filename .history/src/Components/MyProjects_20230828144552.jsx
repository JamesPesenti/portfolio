...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
           ...
           <div style={{paddingHorizontal: 120}}>
            ...
            <p style={{fontSize: 18, paddingHorizontal: 20, marginBottom: -20}}> &#8226; Google Maps functionality to select an Airbnb on the map based on price.</p>
