...
const MyProjects = () => {
  ...
  <>
    ...
    <div style={{ justifyContent: 'center', alignItems: 'center',  width: "80%", borderRadius: 10}} className="box">
            ...
            <p style={{fontSize: 20, textAlign: 'center', padding: 40, marginBottom: -70}}>I created a mobile app clone of the popular Airbnb platform using React Native. Currently, the project includes a functional UI that mimics the 2022 Airbnb interface, with features such as</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 5}}>&#8226; Google autocomplete search</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 0,}}>&#8226; property detail screens</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 0}}>&#8226; an image carousel with pagination</p>
            <p style={{fontSize: 20, textAlign: 'center', padding: 0}}> &#8226; and Google Maps functionality to select Airbnb's on the map based on price. I plan to add additional features and integrate backend functionality in future updates to enhance the user experience and provide a more comprehensive product.</p>
